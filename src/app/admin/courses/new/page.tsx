...
export default async function NewCoursePage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-ink-900 dark:text-white">Add Course</h1>
      <p className="mt-1 text-ink-500 dark:text-ink-400">Create a new course listing.</p>
